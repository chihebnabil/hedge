...
| Trigram Witten-Bell | 483.6 | 15.8% | 27.4% | 4.50 | 64.7 | 0.2 |
| Unigram MLE (floor) | 825.2 | 6.5% | 16.4% | 0.42 | 0.6 | 0.0 |
| Bigram add-1 (Laplace) | 2053.2 | 17.4% | 30.9% | 1.64 | 7.4 | 0.3 |

Correction (2026-09): the Witten-Bell row was re-measured with the corrected
textbook formula. The original baseline divided seen continuations by T while
also passing D/(T+D) of mass to the lower level, so its distribution summed
to more than 1 on seen contexts and deflated its perplexity (246.4 → 483.6).
The corrected ordering matches Chen & Goodman (1998): Witten-Bell loses to
the whole Kneser-Ney family. Every baseline is now guarded by a distribution
sum-to-one test (tests/test_baselines.py). Cost columns are unchanged (the
fix alters arithmetic, not data structures).
